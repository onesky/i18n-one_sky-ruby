  ...
  module OneSky
    ...
    class SimpleClient
      ...
      def initialize(options = {})
        ...
        @one_sky_locale = @platform.details["base_locale"]
        check_default_locales_match
        @one_sky_locales = @platform.locales
      end
      ...
      def save_locale(lang_code, phrases, options={})
        ...
        locale = @one_sky_locales.find { |e| e["locale"] == lang_code }
        ...
        if options[:filename]
          ...
          File.open(filename, 'w') do |f| 
            ...
            f.puts "# Language name: #{lang["name"]["local"]}"
            f.puts "# Language English name: #{lang["name"]["eng"]}"
